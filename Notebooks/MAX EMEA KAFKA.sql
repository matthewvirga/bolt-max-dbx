...
and transaction_Date >= '2024-05-21'
group by all
...
from transactions
where created_date >= '2024-04-05T00:00:00.000+00:00'
...
kinesis_refunds as (
  ...
  from bolt_finint_prod.beam_emea_silver.fi_transaction_enriched
...
-- DBTITLE 1,Emea PPP Extract
select * from plans where region = 'EMEA'
